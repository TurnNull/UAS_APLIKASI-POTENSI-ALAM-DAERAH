    ...
    <nav id="nav-header" class="bg-transparent absolute top-0 left-0 w-full flex items-center z-10">
        <div class="container">
            <div class="flex flex-items justify-between relative">
                <div class="px-4">
                    <a href="{{ route('beranda.index') }}" class="font-bold text-lg text-primary block py-6">
                        @yield('nameNav')
                    </a>
                </div>
                <div class="flex items-center px-4">
                    ...
                    <div id="nav-menu" class="hidden absolute p-5 bg-white shadow-lg rounded-sm max-w-[250px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                        <ul class="block lg:flex">
                            <li class="group">
                                <a href="{{ route('beranda.index') }}" class="text-base text-dark py-2 mx-8 flex group-hover:text-primary group-hover:underline group-hover:underline-offset-4 underline-offset-0 transition-all duration-300">Beranda</a>
                            </li>
                            <li class="group">
                                <a href="{{ route('profil.index') }}" class="text-base text-dark py-2 mx-8 flex group-hover:text-primary group-hover:underline group-hover:underline-offset-4 underline-offset-0 transition-all duration-300">Tentang Kami</a>
                            </li>
                        </ul>
                    </div>
                </div>
